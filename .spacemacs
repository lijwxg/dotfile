...
before packages are loaded."
  ...
  ;; Set push org-mobile-files to org-mobile-directory
  ;; (setq org-mobile-files "~/org")

  ;; Set to the location of your Org files on your local system org-directory
  (setq org-directory "~/Nutstore/org/Mobile")
